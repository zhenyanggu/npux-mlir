...
class LargeGemmModel(nn.Module):
    def __init__(self):
        super().__init__()
        self.fc = nn.Linear(INPUT_SHAPE[1], OUTPUT_FEATURES, bias=True)
...
def main():
    ...
    print("Purpose: reproduce VGG-style large FC with 1000-wide tail path")
