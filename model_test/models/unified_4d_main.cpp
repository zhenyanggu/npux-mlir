...
/* Compare runtime output with golden data and compute summary metrics. */
VerificationSummary compareOutputs(
    const float *actual, const std::vector<float> &golden, int64_t count, float threshold = 0.1f) {
...
int main(int argc, char **argv) {
  constexpr int64_t kInputShape[] = {1, 64, 32, 48};
