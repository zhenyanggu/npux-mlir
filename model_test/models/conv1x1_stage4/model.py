...
class Stage4LikeConvModel(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv = nn.Conv2d(512, 64, kernel_size=1, stride=1, padding=0, bias=True)
...
def main():
    ...
    model = Stage4LikeConvModel().eval()
    ...
    print("Purpose: reproduce ResNet stage4-like 1x1 Conv lowering")
