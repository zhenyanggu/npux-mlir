...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "onnx-mlir.symbol-postfix" = "act_test_quant_sym"} {
  func.func @main_graph(%arg0: memref<1x32xf32> {onnx.name = "input"}) -> (memref<1x32xf32> {onnx.name = "output"}) attributes {llvm.emit_c_interface} {
    ...
    affine.for %arg1 = 0 to 1 {
      affine.for %arg2 = 0 to 32 {
        %5 = affine.load %arg0[0, %arg2] : memref<1x32xf32>
        %6 = affine.load %0[%arg2] : memref<32xf32>
        %7 = arith.addf %5, %6 : f32
        affine.store %7, %alloc[%arg1, %arg2] : memref<1x32xf32>
      }
    }
    ...
    affine.for %arg1 = 0 to 1 {
      affine.for %arg2 = 0 to 32 {
        %5 = affine.load %alloc_0[0, %arg2] : memref<1x32xf32>
        %6 = affine.load %1[%arg2] : memref<32xf32>
        %7 = arith.addf %5, %6 : f32
        affine.store %7, %alloc_1[%arg1, %arg2] : memref<1x32xf32>
      }
    }
  ...
  func.func private @npu_kernel_0(%arg0: memref<1x32xf32>, %arg1: memref<f32>, %arg2: memref<i8>, %arg3: memref<f32>, %arg4: memref<1x32xf32>) attributes {llvm.emit_c_interface, npu.target = "npu"} {
    ...
    affine.for %arg5 = 0 to 32 {
      ...
      affine.store %23, %reshape_6[%arg5] : memref<32xi8>
    }
    %alloc_7 = memref.alloc() {alignment = 64 : i64} : memref<1x32xi8>
    linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel"], library_call = "npu_layernorm"} ins(%alloc : memref<1x32xi8>) outs(%alloc_7 : memref<1x32xi8>) attrs =  {axis = -1 : i64, epsilon = 9.99999974E-6 : f32, in_scale = 0.0227836408 : f32, in_zp = 0 : i32, npu.target = "npu", out_scale = 0.0231352877 : f32, out_zp = 0 : i32} {
    ^bb0(%in: i8, %out: i8):
      %4 = arith.addi %in, %in : i8
      linalg.yield %4 : i8
    }
    %alloc_8 = memref.alloc() {alignment = 64 : i64} : memref<1x32xi8>
    linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel"], library_call = "npu_gelu"} ins(%alloc_7 : memref<1x32xi8>) outs(%alloc_8 : memref<1x32xi8>) attrs =  {in_scale = 0.0231352877 : f32, in_zp = 0 : i32, npu.target = "npu", npu.tiled, npu.trivial_tiling, out_scale = 0.0230970979 : f32, out_zp = 0 : i16} {
    ^bb0(%in: i8, %out: i8):
      %4 = arith.addi %in, %in : i8
      linalg.yield %4 : i8
    }
    %alloc_9 = memref.alloc() {alignment = 64 : i64} : memref<1x32xi8>
    linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel"], library_call = "npu_softmax"} ins(%alloc_8 : memref<1x32xi8>) outs(%alloc_9 : memref<1x32xi8>) attrs =  {axis = -1 : i64, in_scale = 0.0230970979 : f32, in_zp = 0 : i32, npu.target = "npu", out_scale = 0.00787401571 : f32, out_zp = 0 : i16} {
    ^bb0(%in: i8, %out: i8):
      %4 = arith.addi %in, %in : i8
      linalg.yield %4 : i8
    }
    affine.for %arg5 = 0 to 1 {
      affine.for %arg6 = 0 to 32 {
        %4 = affine.load %alloc_9[%arg5, %arg6] : memref<1x32xi8>
        %5 = affine.load %arg3[] : memref<f32>
        %6 = affine.load %arg2[] : memref<i8>
        ...
        affine.store %12, %arg4[%arg5, %arg6] : memref<1x32xf32>
      }
    }
    return
  }
